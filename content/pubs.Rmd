...
Citation                 Description
------------------------ --------------------------------
@quilty2020effectiveness         Traveller screening for symptoms

@clifford2020effect      Traveller screening, sensitisation and contact tracing


@russell2020effect               Risk of importing infections via air travel

@clifford2020strategies          Traveller screening with PCR

@quilty2020quarantine            Quarantine and PCR testing strategies in Test and Trace

@quilty2020effect                Effect of travel restrictions in China

@rees2020covid                   Length of stay in hospital

@jombart2020inferring            Inferring cases from published data on deaths

@10.5281/zenodo.3746662          Forecasting bed occupancy

@liu2020modelling                Health care facility and community surveillance model
-----------------------------------------------------------------
...
Citation                 Description
------------------------ --------------------------------
@Colin2018               Analysing how the scale of spatial aggregation can influence how well a model explains variability in a data set

@colinbrt                Boosted regression trees for spatial modelling of agricultural capacity
...
@airbeam                 Personal exposure assessment for home, office, commuting and other exposure
...
Citation                 Description
------------------------ --------------------------------
@bernard                 Functional data analysis to compare the impact of two different training programs for athletes
