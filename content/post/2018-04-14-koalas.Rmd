...
I've certainly noticed that my coding practice has changed since 2016 and I'm working more and more with tidyverse approaches to analysis, returning results for things as data frames rather than vectors, writing my modelling code in such a way that it's ready for visualisation with [ggplot2](http://ggplot2.tidyverse.org/)`r tufte::newthought("If you're not using ggplot2 by now what are you even doing?")`. I'm glad I put the work in to write a few functions up and put them in mgcv.helper [@mgcv.helper] as they're making their way into this work and some other work I'm revising for air pollution exposure for office workers. So I'm brushing up on meta-analysis techniques and ensuring I'm writing code that simplifies things for me and is easier to follow for the students.
